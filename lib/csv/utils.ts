...
export class Utils implements _Utils {
    private regex: RegExp
    private days: _Day[]
    
    constructor() {
        this.regex = new RegExp("(Mon|Tue|Wed|Thu|Fri|Sat|Sun)-(Mon|Tue|Wed|Thu|Fri|Sat|Sun)|(Mon|Tue|Wed|Thu|Fri|Sat|Sun)", "gi")
        this.days = [_Day.Mon, _Day.Tue, _Day.Wed, _Day.Thu, _Day.Fri, _Day.Sat, _Day.Sun]
    }
    ...
    getTime(datetimeStrings: string): string[] {
        const timeStrings = datetimeStrings.replace(this.regex, "").replace(/[,]/g, "")
